...
playing the chord having a root on each scale degree in ascending or descending order.

By knowing the major, minor, and diminished scale shapes,
and knowing which type of chord has its root on each degree of the major scale,
it's easy to assemble all the chords in position without having all the shapes memorized.

### Play the primary and secondary chords

In a major key, chords I, IV and V are called "primary chords".
...
A surprising number of popular songs are composed of only these primary chords.
It's therefore helpful to practice chord changes between the primary chords.

Chords vi, ii, and iii are called "secondary chords".
...
A good way to practice major key chords in position is by focusing on primary and secondary chords.
(In the example below, vii is thought of as a rootless V7. See details later in this chapter.)

Example primary chord progression to practice: **I-IV-V-vii-I**

Example secondary chord progression to practice: **vi-ii-iii-vi**
...
The circle of fifths/fourths progression is: **I-IV-vii-iii-vi-ii-V-I**

### Play songs you know in one position

Possibly the most useful way to practice these chords is to practice songs you already know,
...
Movement from V7-I is even common in Western popular music.

The V is the only dominant 7 chord that occurs when harmonizing a major key.
That's where the name "dominant 7" comes from.
...
See "euroclassical scale degree names" in {% include chapter-link.html slug="harmony-intro" %} for details.
...
But notice that it contains almost exactly the same notes as the important dominant V7 chord.
