---
title: Introduction to Western harmony
slug: harmony-intro
...
The *quality* of fourth, fifth, octave, and unison intervals is called "perfect",
...
"Minor" intervals are one fret behind (or one "semitone" less than) the major ones.
...
Harmonizing a scale refers to assembling chords from the notes of a given scale,
...
and it will sound the same to all humans,
...
| 5      | Dominant     | A perfect fifth above the tonic. So named because this interval is the dominant harmonic (i.e. the loudest pitch class other than the fundamental) in the [overtone series](glossary.html#overtone-series). |
