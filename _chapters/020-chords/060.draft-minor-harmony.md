...
Once some familiarity with the chords is achieved,
...
Use the leading tone in cadential movements to the tonic.

Try flipping back and forth to think of a chord or tone in context of both the minor and relative major scales.

### Play minor key songs in position

One of the most effective m ways to practice is to play minor key songs we already know using chords in a single position. 
...
{% include figure.html
    ...
    url="/assets/figures/minor-key-triads/2-vii.svg" 
    class="uke-chord row" 
%}
