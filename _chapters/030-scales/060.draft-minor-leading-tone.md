...
even the natural minor scale has a b7.
...
Raising the seventh to the leading tone results in 
...
In this case, by either raising the b6 degree to 6,
or by playing a b7 when descending and the leading tone is not needed.

These choices about whether to raise or lower the sixth and seventh scale degrees lead to the three different minor scales of
